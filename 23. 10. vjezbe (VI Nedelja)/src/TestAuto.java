...
class Auto  {
	...
	private static int brojProdatih = 0;        // ovaj atribut se veze za cijelu klasu (jer je static), ne za neku odredjenu instancu
	
	public Auto(String markaAuta, int godisteAuta, float snagaMotora, boolean prodato, float kubikazaMotora, boolean registrovan) {
		this.markaAuta = markaAuta;     // lijevo od = se odnosi na atribut, desno na konstruktor
	...
	/* public Auto() {
		this.markaAuta = "";
		this.godisteAuta = 1999; ...       ovako bi pisali konstruktor kada korisnik ne unese nista
	} */
	...
	public String toString() {
		return String.format("Auto [marka=%s, godiste=%d, snaga=%.1f, kubikaza=%.1f, registrovan=%s, prodato=%s, cijenaReg=%.2f}",
				markaAuta, godisteAuta, snagaMotora, kubikazaMotora, registrovan ? "da" : "ne",
